...
class FamiliesWithChildrenGraph extends Component {
    constructor(){
        super();
        this.state = {
            chartData:null,
    ...
    render(){
        ...
        if(this.state.chartData){
            return(
                <LineChart charData={this.state.chartData} displayLegend={true} title="Families With Children" legendPosition="bottom"/>
            )
        }
    }
...
export default FamiliesWithChildrenGraph;