...
class DomesticViolenceGraph extends Component {
    constructor(){
        super();
        this.state = {
            chartData:null,
    ...
    render(){
        ...
        if(this.state.chartData){
            return(
                <LineChart charData={this.state.chartData} displayLegend={true} title="Victims of Domestic Violence" legendPosition="bottom"/>
            )
        }
    }
...
export default DomesticViolenceGraph;
