...
export default class NewlyHomelessGrid extends Component{
    constructor(){
        super();
        this.state = {
            urls: ["http://127.0.0.1:8000/api/2020/NewlyHomelessByCity/"],
            rendered : false,
            Tables : []
        }
    }
        ...
        return(
            ...
            <div className="row dash-row">
              ...
              <div className="col-sm-8 dash-col-com">
                <div className="gen-grid">
                    <div className = "gen-r2">
                        ...
                        <TableComponent4 
                            data = {filterList(this.state.Tables["2020/NewlyHomelessByCity"]["Age"],"subpopulation", FILTER_COLUMNS)}
                            tableName = "Age"
                            height = "120%"
                        ...
                        <div className="gen-r2c1r1">
                            ...
                            <PieChart2 
                            data = {filterList(this.state.Tables["2020/NewlyHomelessByCity"]["Ethnicity"],"subpopulation", ["Total"])}
                        ...
                        <PieChart2 
                            data = {filterList(this.state.Tables["2020/NewlyHomelessByCity"]["Gender"],"subpopulation", ["Total"])}
                            margin = {{top: 30,bottom: 20}}
                            />
                    ...
                    <BarGraph 
                      data = {this.state.Tables["2020/NewlyHomelessByCity"]["Race"]}
              ...
              <div className="col-sm-4 dash-col-com" >
                ...
                <div className="gen-r2">
                  <TableComponent4 
                    data = {filterList(this.state.Tables["2020/NewlyHomelessByCity"]["Subpopulations"],"subpopulation", FILTER_COLUMNS)}
