import { urls } from "constants/CityTable";
  ...
  for (var i = 0; i < jsonList.length; i++) {
    ...
    try {
      if (
        ...
        jsonList[i]["subpopulation"] === "Individuals"
      ) {
        differentTables["Individuals"] = jsonList[i];
      }
      ...
      throw Error(
        "INDEX ERROR: expandOnField trying to access the category: " + category
      );
    }
  }
