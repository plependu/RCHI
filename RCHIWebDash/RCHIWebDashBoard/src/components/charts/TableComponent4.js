...
class TableComponent4 extends Component{
  ...
  render(){
    ...
    return(
      <div className="tableContainer" style = {{...this.state.mystyle, height: this.props.divHeight ? this.props.divHeight: '100%', width: "100%", padding: this.props.padding ?  this.props.padding : 0, position: this.props.position ? this.props.position : ''}}>
