        ...
        return(
            ...
            {this.state.rendered ? 
                <div>
                    <Switch>
                        {/* Main Links */}
                        <Route exact path='/' component={ () => < GeneralTable router = {router} Tables = {this.state.Tables} /> } />
                        ...
                        <Route exact path = "/SeniorsDashBoard" component = { () => <SeniorsDashboard router = {router} Tables = {this.state.Tables} /> } />
                        ...
                        <Route exact path='/Map' component={ () => <LLMap router = {router} Tables = {this.state.Tables} /> } />
