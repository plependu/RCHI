...
import { FILTER_COLUMNS, SUBPOP_ORDER } from "constants/UnshelteredVsSheltered";
...
export default class UnsheleteredVsSheltered extends Component {
  ...
  formatData(data) {
    //2019
    data[router.formerYear + "/GeneralTableSubpopulations-unexpanded"] =
      data[router.formerYear + "/GeneralTableSubpopulations"];
    data[
      router.formerYear + "/" + "GeneralTableSubpopulationsSheltered-unexpanded"
    ] = data[router.formerYear + "/" + "GeneralTableSubpopulationsSheltered"];
    data[
      router.formerYear + "/" + "GeneralTableSubpopulations"
    ] = expandOnField(
      data[router.formerYear + "/" + "GeneralTableSubpopulations"],
      "category"
    );
    ...
    //2020
    data[router.activeYear + "/GeneralTableSubpopulations-unexpanded"] =
      data[router.activeYear + "/GeneralTableSubpopulations"];
    data[
      router.activeYear + "/GeneralTableSubpopulationsSheltered-unexpanded"
    ] = data[router.activeYear + "/GeneralTableSubpopulationsSheltered"];
    data[router.activeYear + "/GeneralTableSubpopulations"] = expandOnField(
      data[router.activeYear + "/GeneralTableSubpopulations"],
      "category"
    );
    data[
  ...
  getOrderedUnshelteredData() {
    var result = this.state.Tables[
      ...
      .concat(
        this.state.Tables[router.formerYear + "/GeneralTableSubpopulations"][
          "Age"
        ]
      )
      .concat(
      ...
      .concat(
        this.state.Tables[
          router.activeYear + "/GeneralTableSubpopulations-unexpanded"
        ]
      );
            ...
            <div className="col-md-6 dash-col-com">
              <div className="svu-grid-2">
                ...
                <div className="svu-r2">
                  ...
                  <BarGraph
                    data={shelteredVsUnshelteredMani(
                      changeVals2020(
                        filterList(
                          this.state.Tables[
                            router.activeYear +
                ...
                <div className="svu-r1">
                  <TableComponent4
                    ...
                    data={orderSubs(
                      changeVals2020(
                        filterList(
                          this.getOrderedUnshelteredData(),
                          "subpopulation",
                          FILTER_COLUMNS
                        )
                      ),
