...
model = 'backend.GeneralTableSubpopulationsSheltered' + year 
...
def get_Race_Unknown_Race():
    ...
    for index, row in myData.iterrows():
        val = row["Race"]
        if str(val) == "Client doesn't know" or pd.isna(val) == True or str(val) == "Client refused" or str(val) == "Data not collected":
            counter+=1
...
python_list.append(build_python_object(2,build_nested_python_object("Age","Adults (>24)",get_Age_Adults())))
python_list.append(build_python_object(3,build_nested_python_object("Age","Children (<18)",get_Age_Children())))
python_list.append(build_python_object(4,build_nested_python_object("Age","Youth (18-24)",get_Age_Youth())))
python_list.append(build_python_object(5,build_nested_python_object("Age","Unknown Age",get_Age_Unknown_Age())))
python_list.append(build_python_object(6,build_nested_python_object("Subpopulations","Households (Interview)",get_Subpopulations_Households())))
...
python_list.append(build_python_object(8,build_nested_python_object("Subpopulations","Families w/ Children (Interview)",get_Subpopulations_Families_with_Children())))
...
python_list.append(build_python_object(11,build_nested_python_object("Subpopulations","Veterans Yes",get_Subpopulations_Veterans())))
python_list.append(build_python_object(13,build_nested_python_object("Race","Asian",get_Race_Asian())))
...
python_list.append(build_python_object(23,build_nested_python_object("Gender","Gender Non-Conforming",get_Gender_Gender_Non_Conf())))
python_list.append(build_python_object(24,build_nested_python_object("Gender","Unknown Gender",get_Gender_Unknown())))
python_list.append(build_python_object(25,build_nested_python_object("Ethnicity","Hispanic",get_Ethnicity_Hispanic())))
python_list.append(build_python_object(26,build_nested_python_object("Ethnicity","NonHispanic",get_Ethnicity_Non_Hispanic())))
python_list.append(build_python_object(27,build_nested_python_object("Ethnicity","Unknown Ethnicity",get_Ethnicity_Unknown())))
python_list.append(build_python_object(28,build_nested_python_object("Households","Adults Only",get_Household_Adults_Only())))
python_list.append(build_python_object(29,build_nested_python_object("Households","Adults and Children",get_Household_Adults_and_Children())))
python_list.append(build_python_object(30,build_nested_python_object("Households","Children Only",get_Household_Children_Only())))
python_list.append(build_python_object(31,build_nested_python_object("Subpopulations","Pet Owners",0)))
